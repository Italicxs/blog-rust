...
export default async function Projects() {
  ...
  return (
    <div className="bg-gray-100 min-h-screen py-8">
      ...
      <h3 className="text-md font-bold leading-9 text-yellow-500 text-center cursor-pointer capitalize" translate="no"> <a href="https://www.tiktok.com/@itamakingbases?is_from_webapp=1&sender_device=pc">ItamakingBases</a></h3>
